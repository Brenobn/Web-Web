    ...
    <CardContainer>
      ...
      <Content>
        ...
        <PostInfo>
          ...
          <p>Projeto feito com o curso de html e css no bootcamp dio do Global avanade... <strong>Mais</strong></p>
        </PostInfo>
        <HasInfo>
